...
***************************************************************************** */
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (targetElement.classList.contains("actions-products__button")) {
    ...
    async function getProducts(button) {
        ...
        function loadProducts(data) {
            ...
            data.products.forEach((item => {
                ...
                let productTemplatePricesCurrent = `<div class="item-products__price">Rp ${productPrice}</div>`;
                let productTemplatePricesOld = `<div class="item-products__price item-products__price_old">Rp ${productOldPrice}</div>`;
                let productTemplatePricesEnd = `</div>`;
                productTemplatePrices = productTemplatePricesStart;
                productTemplatePrices += productTemplatePricesCurrent;
                if (productOldPrice) productTemplatePrices += productTemplatePricesOld;
                productTemplatePrices += productTemplatePricesEnd;
                let productTemplateActions = `\n\t\t<div class="item-products__actions actions-products">\n\t\t\t<div class="actions-products__body">\n\t\t\t\t<a href="" class="actions-product__button btn btn_white">Add to cart</a>\n\t\t\t\t<a href="${productShareUrl}" class="actions-products__link _icon-share">Share</a>\n\t\t\t\t<a href="${productLikeUrl}" class="actions-products__link _icon-favorite">Like</a>\n\t\t\t</div>\n\t\t</div>`;
        ...
        if (furniture && !isMobile()) {
            ...
            function setMouseGalleryStyle() {
                ...
                if (Math.abs(distX) > 0) requestAnimationFrame(setMouseGalleryStyle); else furniture.classList.remove("_unit");
            }
